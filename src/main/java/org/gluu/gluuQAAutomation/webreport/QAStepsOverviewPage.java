...
public class QAStepsOverviewPage extends QAAbstractPage {
	public static final String WEB_PAGE = "overview-steps.html";

	public QAStepsOverviewPage(ReportResult reportResult, Configuration configuration) {
	...
	public void prepareReport() {
		...
		// make sure it does not divide by 0 - may happens if there is no step at all or
		// all results have 0 ms durations
