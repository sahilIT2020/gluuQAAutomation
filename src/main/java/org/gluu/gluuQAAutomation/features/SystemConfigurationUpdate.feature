Feature: Update System Configuration
  ...
  Scenario: Configure system as an admin
    ...
    Then    I should see the Self-Service Password Reset set to 'Enabled'
    And     I should see the SCIM Support set to 'Disabled'
    And     I should see the Passport Support set to 'Disabled'
